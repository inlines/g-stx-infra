...

{
  ...
  "panels": [
      ...
      "targets": [
        {
          ...
          "expr": "sum(rate(api_http_requests_total[1m])) by (endpoint)",
          "format": "time_series",
          "interval": "",
      ...
      "targets": [
        {
          ...
          "expr": "histogram_quantile(0.95, sum(rate(api_http_requests_duration_seconds_bucket[5m])) by (le, endpoint))",
          "format": "time_series",
          "interval": "",
      ...
      "targets": [
        {
          ...
          "expr": "sum(api_http_requests_total) by (endpoint)",
          "format": "time_series",
          "interval": "",
          "legendFormat": "Total {{endpoint}}",
          "refId": "A"
        }
      ],
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "sum(auth_failures_total) by (username)",
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "sum(rate(auth_failures_total[5m])) by (ip)",
          "legendFormat": "{{ip}}",
          "refId": "A"
        }
      ],
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "sum(rate(jwt_tokens_issued_total[1h]))",
      ...
      "targets": [
        {
          ...
          "expr": "sum(rate(api_http_requests_total{status!~\"200\"}[1m])) by (endpoint, status)",
          "format": "time_series",
          "interval": "",
